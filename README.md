...
<div align="center">안녕하세요! 저는 한국공학대 메카트로닉스공학부 23학번 문시현이라고 합니다<br>전자제어를 중심으로 로보틱스와 방산/항공등 넓은분야에 관심이 많고 관련된 재밌는 프로젝트들을 진행중입니다</div>
...
<div align="center">
  <ul>
    ...
    <li>미래 함정 아이디어 경진대회 <b>장려상</b></li>
    <li>교내 지능형 로봇활용 창의설계 작품 경진대회 <b>장려상</b></li>
    <li>교내 제 4회 총장배 로봇프로그래밍 경진대회 <b>1위</b></li>
  </ul>
</div>
